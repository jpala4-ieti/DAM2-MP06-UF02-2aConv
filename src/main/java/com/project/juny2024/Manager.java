...
public class Manager {
    ...
    public static Departament addDepartament(String nom) {
    }

    public static Empleat addEmpleatToDepartament(Long departamentId, String nom) {
        return empleat;
    }

    public static Projecte addProjecte(String nom, String inici, String fi) {
    }

    public static void assignEmpleatToProjecte(Long projecteId, Empleat empleat) {
    }
